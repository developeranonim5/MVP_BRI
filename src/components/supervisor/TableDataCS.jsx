...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>Otto</td>
      <td>
        <button type="submit" name="import" class="btn btn-warning">Detail</button>&nbsp;
        <button type="submit" name="import" class="btn btn-dark">Detail</button>
      </td>
    </tr>
    <tr>
      <th scope="row">2</th>
      <td>Jacob</td>
      <td>Thornton</td>
      <td> <button type="submit" name="import" class="btn btn-warning">Detail</button>&nbsp;
        <button type="submit" name="import" class="btn btn-dark">Detail</button></td>
    </tr>
    <tr>
      <th scope="row">3</th>
      <td>Larry</td>
