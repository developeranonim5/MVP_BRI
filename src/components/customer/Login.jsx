...
<div className="container">
  ...
  <div className="col-xl-5 col-md-5 mt-5 ">  
    <div class="card shadow">
    <div class="card-header py-3">
    <h2 class="m-0 font-weight-bold text-dark text-center"><i class="fa fa-pen-alt"></i> Form Sign In</h2>
    </div>
    <div class="card-body">
      <form class="" action="POST">
        ...
        <div class="form-group ml-auto">
            <button type="submit" id="btnUpload" name="import" class="btn btn-dark btn-block"><i class="fa fa-upload fa-fw"></i>Sign In</button>
        </div>
      </form>
    </div>
  </div>
